...
def user_stock_record(name:str = '李华', stock_code:str = 'sh600089', stock_name:str = '特变电工', num:int = 0, price:float = 0.0, time:str = '2020-01-01' ,decrease:bool = 0, say:int = 0) ->tuple[bool, str]:
