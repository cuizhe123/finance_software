...
'''
def history_stock_search(stock_code:str = '', say:int = 0)->tuple[list[dict], str]:
...
def history_market_search(market_code:str = 'sh000001', say:int = 0)->tuple[list[dict], str]:
    "获取大盘指数的历史数据，传入大盘指数代码market_code，必须有市场标识如sh、sz、bj，返回历史数据,dict = {'id', 'time', 'market_code', 'market_name', 'exchange', 'open_price', 'close_price', 'high_price', 'low_price', 'trade_num', 'trade_money', 'amplitude', 'up_down', 'price_range', 'turnover_ratio'}"
